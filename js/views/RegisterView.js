                            ...
                            <div style="margin-top: 24px;">
                                ...
                                <div style="display: flex; flex-direction: column; gap: 12px;">
                                    ...
                                    <div class="file-upload-wrapper">
                                        ...
                                        <input type="file" id="file-dni" accept=".pdf" required style="width: 100%; color: #94A3B8; font-size: 0.8rem; background: rgba(0,0,0,0.2); padding: 8px; border-radius: 8px;">
                                    </div>
                                    
                                    <!-- CertiAdulto (Todos) -->
                                    <div class="file-upload-wrapper">
                                        <label style="display: block; color: #CBD5E1; font-size: 0.8rem; margin-bottom: 4px;">Certiadulto (Obligatorio)</label>
                                        <input type="file" id="file-certiadulto" accept=".pdf" required style="width: 100%; color: #94A3B8; font-size: 0.8rem; background: rgba(0,0,0,0.2); padding: 8px; border-radius: 8px;">
                                    </div>
                                    ...
                                    <div id="technical-docs-wrapper" style="display: flex; flex-direction: column; gap: 12px;">
                                        <div class="file-upload-wrapper">
                                            ...
                                            <input type="file" id="file-cv" accept=".pdf" required style="width: 100%; color: #94A3B8; font-size: 0.8rem; background: rgba(0,0,0,0.2); padding: 8px; border-radius: 8px;">
                                        </div>
                                        
                                        <div class="file-upload-wrapper">
                                            <label style="display: block; color: #CBD5E1; font-size: 0.8rem; margin-bottom: 4px;">Certificados de Trabajo (PDF)</label>
                                            <input type="file" id="file-certificados" accept=".pdf" required style="width: 100%; color: #94A3B8; font-size: 0.8rem; background: rgba(0,0,0,0.2); padding: 8px; border-radius: 8px;">
                                        </div>
                                    </div>
                                </div>
                            </div>
